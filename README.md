...
<table>
  ...
  <tr>
    ...
    <td><strong>Fernandez Alva, Maria Fernanda</strong><br><strong>TB1:</strong> Elaboró los cuadros comparativos de competencias y un análisis competitivo, además de diseñar las entrevistas aplicables al proyecto.<br><strong>TP:</strong> Elaboró el informe con respecto al sprint 1, evaluando que el cntenido este de acuerdo con el avance del proyecto.<br><strong>TB2:</strong> Elaboró los siguiente puntos para el informe: 6.2.2.3 y 6.2.2.4.<br><br><strong>TF:</strong> Endureció el backend para Release (migraciones/semillas), afinó CI/CD y variables de entorno para despliegues finales, y consolidó Services Documentation Evidence con ejemplos de request/response usados en la demo.</td>
    <td rowspan="7"><strong>TB1:</strong> En esta primera entrega, como grupo logramos ejercer un liderazgo compartido en las distintas etapas del trabajo, ya que cada integrante asumió la responsabilidad de coordinar y liderar tareas específicas como la elaboración de cuadros comparativos, el diseño de entrevistas, la construcción de user personas y la definición de matrices y escenarios. Esta distribución equitativa permitió que el equipo funcione de manera organizada, sin depender de un único líder, y que se avance de forma colaborativa en los capítulos I a IV del proyecto.<br><br><strong>TP:</strong> En esta segunda entrega, nos repartimos con el grupo para entregar de tanto el frontend , backend y la landing page abordando la mayor parte de los user stories especialmente para el segmento objetivo de veterinario. Como equipo nos ayudamos mutuamente para que tengamos todo lo que nos piden en el trabajo.<br><br><strong>TB2:</strong> Como equipo, durante este Sprint consolidamos el avance técnico del proyecto PetLink mediante la integración efectiva de los módulos IoT, backend y aplicación móvil. Se trabajó en la simulación funcional del dispositivo IoT, la implementación y mejora de los endpoints del backend, el registro y consulta de datos en la nube, así como la correcta visualización de la información desde la aplicación móvil. Realizamos pruebas constantes de comunicación, asegurando que los datos generados por la pechera IoT —como signos vitales, estados de salud y eventos clínicos— fueran procesados de forma confiable por el backend y pudieran ser consultados desde el entorno móvil. También generamos evidencias de desarrollo, pruebas y despliegue, cumpliendo con las actividades planificadas en el Sprint Backlog. El trabajo colaborativo permitió demostrar la viabilidad de la solución integral y fortaleció la cohesión entre las áreas de desarrollo IoT, backend y mobile dentro del proyecto.<br><br><strong>TF:</strong> Coordinó la integración final del Sprint 3, cerró hallazgos del QA de documentación (registro de versiones, Student Outcome y anexos) y guionó la demo para la Release Review, asegurando coherencia entre evidencia de ejecución, pruebas y despliegues finales.<br><br></td>
  </tr>
  <tr>
    <td><strong>Belleza Tello, Paolo Eduardo</strong><br><strong>TB1:</strong> Desarrolló los perfiles de los dos segmentos objetivo mediante la construcción de user personas, el empathy mapping y el as-is scenario. Estas actividades se realizaron en coordinación grupal para integrar diferentes perspectivas.<br><strong>TP:</strong> Desarrolló el informe del despliegue tanto del frontend como de la landing page.<br><strong>TB2:</strong> Elaboró los puntos 6.2.2.5 y 6.2.2.5 junto con el repositorio de acceptance-criterio.<br><br><strong>TF:</strong> Cerramos el Release con la versión final desplegada de los productos, evidencias completas de Sprint 3 (planning, backlog, desarrollo, testing, ejecución y documentación de servicios) y actualización del Final Project Report y Keynote. El equipo mostró liderazgo distribuido para priorizar correcciones críticas y orquestar la demo de fin de ciclo conforme a TF1.</td>
  </tr>
  <tr>
    <td><strong>Pilares Pocohuanca, Maria</strong><br><strong>TB1:</strong> En esta primera entrega, fomenté la participación activa lo que ayudó en la toma de decisiones clave para el proyecto. Del mismo modo para el desarrollo óptimo de los bounded contexts, los cuales son fundamentales para dividir las funcionalidades principales de la aplicación por módulos.<br><br><strong>TP:</strong> En esta segunda entrega, nos reunimos los miembros del grupo para entregar un buen trabajo con todos los requerimientos que se solicitaban en el trabajo parcial.<br><br><strong>TB2:</strong> Durante el sprint 2, participé activamente en el equipo, centrándome en la validación de la aplicación por medio de entrevistas a los dos segmentos objetivos. Mi responsabilidad fue asegurar las evaluaciones según heurísticas y con ello poder realizar en el futuro, una mejora continua como lo solicitan los usuarios.<br><br><strong>TF:</strong> Pulió el Landing Page (i18n/SEO y consistencia de estilo), consolidó release notes y métricas de ejecución, y verificó vínculos cruzados del informe con evidencias de despliegue y video About-the-Product para la entrega final.</td>
  </tr>
  <tr>
    <td><strong>Chávarri Zarzosa, Daniel Jhared</strong><br><strong>TB1:</strong> Trabajó todo el capítulo I de manera adecuada, elaboró el EventStorming y el Software Architecture del capítulo IV. Estas tareas asignadas a cada integrante del equipo fueron de manera equitativa y organizada, a fin de que cada uno pueda cumplir a tiempo.<br><strong>TB2</strong> En esta etapa del proyecto, mi contribución se centró en el desarrollo y validación de la solución IoT utilizando Wokwi para simular una pechera inteligente equipada con un microcontrolador ESP32 y un sistema de notificación visual mediante LEDs de colores verde, amarillo y rojo. Esta simulación representó el comportamiento real del dispositivo físico, enviando datos de signos vitales (ritmo cardíaco, estado y timestamp) hacia el backend del sistema. Además, realicé la integración completa entre la simulación IoT, el backend desplegado en la nube y la aplicación móvil, asegurando que los datos transmitidos desde el ESP32 fueran correctamente recibidos, procesados y almacenados en la base de datos cloud. Finalmente, verifiqué la recepción de datos mediante los endpoints del Swagger y realicé la carga de información real en la BD para permitir las pruebas de la aplicación móvil. Con ello, consolidé el flujo IoT → Backend → App, asegurando su correcto funcionamiento como parte clave del Sprint 2.<br><br><strong>TF:</strong> Lideró el Sprint 3 Planning, cerró observaciones de heurísticas y preparó el guion y captura de Ejecución (screens/videos) que demuestran rutas felices y alternativas en la app, enlazadas al reporte final.<br></td>
  </tr>
  <tr>
    <td><strong>Góngora Sánchez, Marco Antonio</strong><br><strong>TB1:</strong> Desarrolló impacts mappings para cada segmento identificando business goals y user stories que manifiesten el cumplimiento de estos. También desarrolló el product backlog priorizando a los user stories mediante story points. <br><strong>TP:</strong> Desarrolló Web, Mobile and IoT Devices Style Guidelines para una base de diseño a nuestros productos. También desarrolló los wireframes y los user flows de cada pantalla. <br><strong>TB2: Desarrollé la introducción al sprint 2 y el about the product.<br><br><strong>TF:</strong> Estabilizó el pipeline IoT → Backend → App para el Release Candidate, documentó los endpoints en Swagger usados en la demo y generó datasets de prueba para la Ejecución y Testing del Sprint 3.</strong></td>
  </tr>
  <tr>
    <td><strong>Rondon Añaños, Cristopher</strong><br><strong>TB1:</strong> Desarrollé el product backlog además de colaborar con las entrevistas del usuario <br><strong>TP:</strong> Hice el diseño y despliegue de la landing page <br><strong>TB2:</strong> Hice el diseño y despliegue de nuestra mobile app.<br><br><strong>TF:</strong> Aseguró consistencia visual entre LP, web y móvil para el Release, actualizó assets y microcopys finales y coordinó la edición del video About-the-Product embebido en el informe/keynote.</td> 
  </tr>
  <tr>
    <td><strong>Mayurí Armas, Jose Carlo</strong><br><strong>TB1:</strong> Elaboró íntegramente la documentación y diagramas técnicos del capítulo 4.2 (IAM, Management y Records), aplicando Domain-Driven Design. Además, integró estos entregables al repositorio en GitHub con commits organizados, lo cual permitió mantener un control de versiones ordenado y transparente para el equipo.<br><br><strong>TF:</strong> Preparó el build de release de la app móvil (configuración de firma/paquetes), ejecutó pruebas de ejecución grabadas para la demo final y publicó el artefacto en el canal acordado para la revisión.</td>
  </tr>
  <tr>
    ...
    <td><strong>Fernandez Alva, Maria Fernanda</strong><br><strong>TB1:</strong> Investigó en internet productos similares al prototipo, identificando coincidencias en objetivos y funcionalidades.<br><strong>TP:</strong> Reviso el repositorio para visualizar que el trabajo se haya subido correctamente con la nomenclatura adecuada.<br><strong>TB2:</strong> Reviso que las entrevistas se hayan subido en el lugar correcto e igual verifico que los punto que elaboró se hayan hecho de forma correcta.<br><br><strong>TF:</strong> Automatizó pipelines de despliegue para el Release, cerró pendientes de documentación de servicios (OpenAPI) y validó variables/secretos para ambientes finales.</td>
    <td rowspan="7"><strong>TB1:</strong> En esta primera entrega, el equipo desarrolló un entorno colaborativo e inclusivo, donde se integraron las ideas de todos los miembros mediante el uso de herramientas como Miro y UXPressia, además de la comunicación constante en reuniones. Se establecieron metas claras en cada capítulo del proyecto (Introducción, Requirements Elicitation & Analysis, Requirements Specification y Solution Software Design), se distribuyeron las tareas de manera equitativa y se cumplieron los objetivos planificados. Este trabajo coordinado aseguró que el proyecto avance de manera ordenada, inclusiva y con un alto nivel de compromiso por parte de todos los integrantes.<br><br><strong>TP:</strong> En esta segunda entrega, el equipo desarrollo secciones o partes para que cada uno se sienta mas comodo con lo que sabe elaborar. Todos hiciemos tareas diferentes pero aun asi nos ayudamos o verificamos que lo que hicieron nuestros compañeros este en correto estado. Se establecieron metas claras para abordar correctamente el capitulo 5 y el capitulo 6 con el primer sprint.<br><br><strong>TB2:</strong> Como equipo, durante este Sprint consolidamos el avance técnico del proyecto PetLink mediante la integración efectiva de los módulos IoT, backend y aplicación móvil. Se trabajó en la simulación funcional del dispositivo IoT, la implementación y mejora de los endpoints del backend, el registro y consulta de datos en la nube, así como la correcta visualización de la información desde la aplicación móvil. Realizamos pruebas constantes de comunicación, asegurando que los datos generados por la pechera IoT —como signos vitales, estados de salud y eventos clínicos— fueran procesados de forma confiable por el backend y pudieran ser consultados desde el entorno móvil. También generamos evidencias de desarrollo, pruebas y despliegue, cumpliendo con las actividades planificadas en el Sprint Backlog. El trabajo colaborativo permitió demostrar la viabilidad de la solución integral y fortaleció la cohesión entre las áreas de desarrollo IoT, backend y mobile dentro del proyecto.<br><br><strong>TF:</strong> Facilitó el checklist de cierre (deploys, videos, enlaces públicos y trazabilidad entre informe–keynote–evidencias) y coordinó la agenda de la Release Review.<br></td>
  </tr>
  <tr>
    <td><strong>Belleza Tello, Paolo Eduardo</strong><br><strong>TB1:</strong> Utilizó herramientas digitales como UXPressia y Miro para elaborar y organizar los requisitos del proyecto, asegurando la claridad y trazabilidad de los mismos dentro del proceso de diseño.<br><strong>TP:</strong> Averiguo diferentes paginas para desplegar de la manera correcta y segura el frontend , backend y landing page. En este caso, se desplego en Netfily por su gran facilidad y seguridad de desplegar de manera pública el frontend.<br><strong>TB2:</strong> Averiguo como escribir de manera correcta los acceptance criterios para el informe, en especial visualizar como los user stories implementados para este sprint funcionen de manera correcta.<br><br><strong>TF:</strong> Para el Release se cumplieron los hitos de TF1: planificación y ejecución de Sprint 3, consolidación del Final Project Report/Keynote, despliegues finales y evidencias completas (desarrollo, testing, ejecución y documentación de servicios). La coordinación transversal permitió cerrar issues críticos y presentar una demo integrada y verificable.</td>
  </tr>
  <tr>
    <td><strong>Pilares Pocohuanca, Maria</strong><br><strong>TB1:</strong> Facilité el uso de herramientas colaborativas y organicé sesiones para revisar el progreso del equipo, tales como reuniones en Google Meet, además de diseñar modelos de dominio y de arquitectura que permitieron una mejor comprensión de la solución.<br><br><strong>TB2:</strong> Se mantuvo una comunicación continua con el equipo, aplicando los comentarios recibidos del profesor, con el fin de realizar algunos ajustes y mejorar la experiencia del usuario. El enfoque en los objetivos del sprint permitió cumplir con los entregables, manteniendo la calidad y alineación con los requisitos del proyecto en cada iteración.<br><br><strong>TF:</strong> Consolidó tableros y enlaces públicos (Boards/Repos/Swagger/Figma/Videos), mejoró la navegación del LP y verificó accesibilidad básica en la presentación final.</td>
  </tr>
  <tr>
    <td><strong>Chávarri Zarzosa, Daniel Jhared</strong><br><strong>TB1:</strong> En esta entrega, tuvo apoyo de algunas herramientas tecnológicas para el desarrollo de la tarea asignada, investigó sobre las cosas nuevas que tiene el curso y con ello se pudo realizar de manera adecuada y eficiente este primer avance del proyecto, con ayuda del equipo en mantener el ritmo de avance semana a semana.<br><strong>TB2:</strong> En esta etapa del proyecto, mi contribución se centró en el desarrollo y validación de la solución IoT utilizando Wokwi para simular una pechera inteligente equipada con un microcontrolador ESP32 y un sistema de notificación visual mediante LEDs de colores verde, amarillo y rojo. Esta simulación representó el comportamiento real del dispositivo físico, enviando datos de signos vitales (ritmo cardíaco, estado y timestamp) hacia el backend del sistema. Además, realicé la integración completa entre la simulación IoT, el backend desplegado en la nube y la aplicación móvil, asegurando que los datos transmitidos desde el ESP32 fueran correctamente recibidos, procesados y almacenados en la base de datos cloud. Finalmente, verifiqué la recepción de datos mediante los endpoints del Swagger y realicé la carga de información real en la BD para permitir las pruebas de la aplicación móvil. Con ello, consolidé el flujo IoT → Backend → App, asegurando su correcto funcionamiento como parte clave del Sprint 2.<br><br><strong>TF:</strong> Coordinó la retrospectiva de cierre, priorizando mejoras rápidas previas a la entrega y asegurando que las capturas y videos de Ejecución cubran los flujos críticos definidos para el Release.<br></td>
  </tr>
  <tr>
    <td><strong>Góngora Sánchez, Marco Antonio</strong><br><strong>TB1:</strong>Para este entrega utilizó UXPRESSIA para la realización de los impacts mappings dando un mejor panorama y contexto detrás.<br><strong>TP:</strong> Utilizó guías de oficiales de grandes productos (Google, Microsoft) para tomar cómo referencia directa los colores, tipografía, componentes, spacing, etc. Finalemnte, para los wireframes y userflows, se usó Figma y una extensión especializada para hacer flujos de usuario.<br><strong>TB2:</strong> Para esta entrega utilizó Canvas para la realización del about the product.<br><br><strong>TF:</strong> Organizó pruebas de humo post-despliegue, validó logs/telemetría y actualizó la evidencia de ejecución con timestamps para la revisión final.</td>
  </tr>
  <tr>
    <td><strong>Rondon Añaños, Cristopher</strong><br><strong>TB1:</strong> Use herramientas y convenciónes para redactar nuestras historias de usuario y criterios de aceptación <br><strong>TP:</strong> Usé Figma como herramienta de diseño así como Tailwind para la estilización de la landing page <br><strong>TB2:</strong> Utilicé figma para el diseño de la aplicación y el framework de flutter para el desarrollo.<br><br><strong>TF:</strong> Realizó el Keynote final (estructura, capturas, enlaces y narrativa) y verificó que los artefactos visuales estén actualizados respecto a la versión liberada.</td> 
  </tr>
  <tr>
    <td><strong>Mayurí Armas, Jose Carlo</strong><br><strong>TB1:</strong> Colaboró activamente con el equipo integrando los diagramas técnicos al repositorio en GitHub mediante commits organizados, lo cual permitió un control de versiones ordenado. Su aporte garantizó que el proyecto mantenga consistencia en los entregables y fluidez en la coordinación grupal.<br><br><strong>TF:</strong> Gestionó entregables móviles (build, artefacto y guía de instalación), y registró evidencia de Testing/Ejecución en vídeo para la revisión.</td></td>
  </tr>  
</table>
...
* **Evidencia 3: Conexión entre la Landing Page y Mobile App**
  Se confirma que se puede acceder a la Mobile App mediente el boton de `Descargar App móvil` que tiene la Landing Page.
    ...
    <div style="display: flex; justify-content: center; gap: 10px;">
      <img src="./Capitulo 6/Sprint3/landing-cambio-2.png">
    </div><br>
...
- **URL del video demostrativo de las conexiones entre el dispositivo IoT con las aplicaciones:** https://upcedupe-my.sharepoint.com/:v:/g/personal/u20191a137_upc_edu_pe/IQCAGDgJp2cMRKueGa-iRg47ASNTRjcoU6A8yV0-RoxjlJw?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=z1HHnq
